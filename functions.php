...
function philoshopy_assets(){
    ...
    wp_enqueue_script('modernizr', get_template_directory_uri().'/assets/js/modernizr.js', array(),'false','true');
    wp_enqueue_script('pace', get_template_directory_uri().'/assets/js/pace.min.js', array(),'false','true');
    wp_enqueue_script('jsplugins', get_template_directory_uri().'/assets/js/jsplugins.js', array(),'false','true');
    wp_enqueue_script('jsmain', get_template_directory_uri().'/assets/js/jsmain.js', array(),'false','true');
}
